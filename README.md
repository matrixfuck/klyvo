...
Klyvo в бете, v0.4.0. Основное уже работает: перехват с блокировкой критичного,
запрос подтверждения на предупреждения, журнал сессии, локальный веб-дашборд.
Дальше будет много обновлений. Историю версий смотрите в [CHANGELOG.md](CHANGELOG.md).
